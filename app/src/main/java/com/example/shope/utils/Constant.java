...
public class Constant {
    public static String BASE_URL = "http://192.168.88.221:5000/api/v1/";
    public static String ADDRESS_URL = "https://vapi.vnappmob.com/api/";
    public static String YOUR_CLIENT_ID = "AWJcLfDMw4AGJ0bJoqxEsu55qLokksCamnvZ7SpV4R6pY8ggnG9YEuFEfsbIkMYsX4EUklauYhtOYJX0";
